 ...
 *
 * Delta from v097: none. v098 adds the optional `localNotebaseId` field to
 * selection-toolbar actions, and no v097 series holds that field — the
 * migration is an identity transform. Identical content is therefore the
 * correct assertion here: it pins that the new field leaves untouched configs
 * byte-for-byte alone.
 */
